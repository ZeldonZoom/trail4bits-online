...
from flaskblog.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestPasswordFrom, RequestResetForm
from flaskblog import app, bcrypt, db, bcrypt, mail
